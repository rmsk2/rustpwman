...
impl Cryptor for Gcm256Context {
    fn decrypt(&mut self, password: &str, data: &Vec<u8>) -> std::io::Result<Vec<u8>> {
        return self.0.decrypt_aead::<AesGcm::<aes::Aes256, typenum::U12>>(password, data, ALGO_AES256);
    }

    fn encrypt(&mut self, password: &str, data: &Vec<u8>) -> std::io::Result<Vec<u8>> {
        return self.0.encrypt_aead::<AesGcm::<aes::Aes256, typenum::U12>>(password, data, ALGO_AES256);
    }
...
impl Cryptor for Gcm192Context {
    fn decrypt(&mut self, password: &str, data: &Vec<u8>) -> std::io::Result<Vec<u8>> {
        return self.0.decrypt_aead::<AesGcm::<aes::Aes192, typenum::U12>>(password, data, ALGO_AES192);
    }

    fn encrypt(&mut self, password: &str, data: &Vec<u8>) -> std::io::Result<Vec<u8>> {
        return self.0.encrypt_aead::<AesGcm::<aes::Aes192, typenum::U12>>(password, data, ALGO_AES192);
    }
