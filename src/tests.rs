...
pub fn test_jots_serialize_deserialize() {
    ...
    {
        let mut j = jots::Jots::new_str(fcrypt::GcmContext::sha256_deriver, fcrypt::KDF_SHA256);
        j.insert(&t1, &d1);
        j.insert(&t2, &d2);
        j.insert(&t3, &d3);
    ...
    let mut j2 = jots::Jots::new_str(fcrypt::GcmContext::sha256_deriver, fcrypt::KDF_SHA256);
