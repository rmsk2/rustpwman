...
- Beginning with version 0.8 the name of key derivation function is stored in the encrypted data file. You may have to manually add the line `"PbKdf": "sha256",` to the corrsponding JSON file.
