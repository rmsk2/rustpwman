...
- On Windows a spurious Escape sequence is often the first character which is printed when using quit and print. This does not happen on Linux or MacOS. It happens less frequently when using the Windows terminal.
