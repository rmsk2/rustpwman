...
- Starting with version 2.10.0 `rustpwman` also makes some effort to cryptographically obfuscate sensitive data in memory which should decrease the likelihood of such attacks succeeding at least as long as the attacker does not actively attempt to circumvent the obfuscation mechanism.
